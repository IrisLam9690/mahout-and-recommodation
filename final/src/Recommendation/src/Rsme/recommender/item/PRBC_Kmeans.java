...
import Rsme.calculate.Kmeans;
import Rsme.cluster.Category;
import Rsme.cluster.HACluster;
import Rsme.cluster.KMeansCluster;
...
public class PRBC_Kmeans extends ItemRecommender{
final public static int DEFAULT_CLUSTER_SIZE = 50;
	...
	public void buildRecommender(DataModel dataModel) throws Exception {
		...
		clusters = KMeansCluster.clusterForTag(folksonomy, DEFAULT_CLUSTER_SIZE);
	...
	public static void main(String[] args) throws Exception {
		...
		PRBC_Kmeans prbc = new PRBC_Kmeans();
